## Overview
This repository deminstrates basic understandings of QGIS functionality through the completion of 10 tutorial available on qgistutorials.com.
types of GIS skills practiced

## Software Environment
QGIS Version Used: QGIS Desktop 3.44.9
...
What was challenging?  In the spatial queries tutorial, I ran into an issue in step 12 where the Reproject layer was running with no error, but the file it developed had no points within it. This only happened for the metro stations file and the bars and pubs file had no issues reprojecting in the previous step. I looked up the issue and sidestepped the Reproject Layer tool by exporting the layer and reprojected the point file via the export. This fix was successful and I was able to proceed with the rest of the tutorial.
How do you anticipate using these skills?
